    ...
    public class RoleService : IRoleService
    {
        ...
        public async Task<ApiResponse<bool>> DeleteAsync(Guid id)
        {
            try
            {
                ...
                // Kiểm tra xem có UserDepartment nào đang sử dụng role này không
                var userDepartmentsWithRole = await _unitOfWork.UserDepartments.FindAsync(ud => ud.RoleId == id);
                if (userDepartmentsWithRole.Any())
                {
